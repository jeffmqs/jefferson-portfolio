...
const Work = ({ isDarkMode }) => {
  return (
    ...
    scroll-mt-20'>
        ...
        Confira alguns projetos que desenvolvi, aplicando soluções em desenvolvimento web, dados e experiência do usuário..</motion.p>

<motion.div 
initial={{opacity:0}}
whileInView={{opacity:1}}
transition={{delay: 0.9, duration: 0.6}}
className='grid [grid-template-columns:repeat(auto-fit,minmax(200px,1fr))] gap-5 my-10 dark:text-black'>
